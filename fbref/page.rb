...
require 'sportdb/structs'     ## pull in Season -- todo/fix: turn into standalone gem "season-formats"!!!
...
def self.convert( league:, season: )
  ...
  path = "o/#{league}-#{season.to_path}.csv"
...
[
  ...
  page = Page.from_file( "dl/#{league}.html" )
  ...
  Writer.write( "o/#{league}.csv", rows )
end
